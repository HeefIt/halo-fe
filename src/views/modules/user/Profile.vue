...
const achievements = ref([
  { id: 1, name: '初学者', description: '完成第一道Java八股文', icon: 'Star', unlocked: true },
  { id: 2, name: '坚持者', description: '连续7天学习Java八股文', icon: 'Medal', unlocked: true },
  { id: 3, name: '挑战者', description: '完成100道Java八股文', icon: 'Trophy', unlocked: false }
])
